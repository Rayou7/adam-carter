...
final class WrappedTemplatedEmail
{
     ...
     * @param string|null $contentType The medias type (i.e. MIME type) of the image file (e.g. 'image/png').
     ...
     * @param string|null $contentType The medias type (i.e. MIME type) of the file (e.g. 'application/pdf').
