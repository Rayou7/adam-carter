                            ...
                            ->arrayPrototype()
                                ...
                                ->children()
                                    ...
                                    ->arrayNode('allowed_media_schemes')
                                        ->info('Allows only a given list of schemes to be used in medias source attributes (img, audio, video, ...).')
                                        ->scalarPrototype()->end()
                                    ->end()
                                    ->variableNode('allowed_media_hosts')
                                        ->info('Allows only a given list of hosts to be used in medias source attributes (img, audio, video, ...).')
                                        ->defaultValue(null)
                                        ->validate()
                                            ->ifTrue(fn ($v) => !\is_array($v) && null !== $v)
                                    ...
                                    ->booleanNode('allow_relative_medias')
                                        ->info('Allows relative URLs to be used in medias source attributes (img, audio, video, ...).')
                                        ->defaultFalse()
                                    ->end()
